$(document).ready(function() {
    ...
    function fetchriwayats(page = 1) {
        $.ajax({
            ...
            success(response) {
                $('#riwayatTableContainer').html(response.html);
                updateUrl(page);
            },
            error() {
    ...
    // Bulk delete
    $(document).on('submit', '#deleteFormriwayat', function(e) {
        e.preventDefault();
        Swal.fire({
            title: 'Hapus Semua riwayat Terpilih?',
