        ...
        <div class="w-full p-10 mx-auto">
            ...
            <div class="flex flex-row justify-between mb-3">
                ...
                <div class="flex flex-row space-x-4 items-center">
                    ...
                    {{-- SEARCH BAR --}}
                    <form action="{{ route('penjualan_obats.index') }}" method="GET" class="relative">
            ...
            {{-- Tabel Data Obat --}}
            <form id="deleteForm" action="{{ route('penjualan_obats.destroy', ['penjualan_obat' => 0]) }}"
                method="POST">
                @csrf
                @method('DELETE')
                <table class="min-w-full bg-white border rounded-xl shadow-sm mb-5">
                    ...
                    <tbody>
                        @foreach ($penjualan_obats as $penjualan_obat)
                            <tr class="border">
                                <td class="px-4 py-3">
                                    <input type="checkbox" name="penjualan_obats[]"
                                        value="{{ $penjualan_obat->id }}"
            ...
            <!-- Pagination links -->
            <div class="mt-4">
                {{ $penjualan_obats->appends(['search' => request('search'), 'perPage' => request('perPage')])->links() }}
            </div>
        </div>
    </div>
