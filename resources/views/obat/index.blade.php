                ...
                <div class="w-full p-10 mx-auto">
                    ...
                    <div class="flex flex-row justify-between mb-3">
                        <div class="flex flex-row gap-4">
                            ...
                            {{-- Delete Button --}}
                            <button form="deleteFormObat" type="submit"
                            ...
                            <div class="flex flex-row gap-2">
                                ...
                                <button id="sortByButton"
                                    ...
                                    <div id="sortByPopup"
                                        ...
                                        <div class="py-2 px-4 cursor-pointer sort-option hover:bg-gray-50 hover:text-gray-800"
                                            data-sortby="kode_obat">Kode Obat</div>
                                        <div class="py-2 px-4 cursor-pointer sort-option hover:bg-gray-50 hover:text-gray-800"
                                            data-sortby="nama_obat">Nama Obat</div>
                                        <div class="py-2 px-4 cursor-pointer sort-option hover:bg-gray-50 hover:text-gray-800"
                                            data-sortby="stok">Stok</div>
                                        <div class="py-2 px-4 cursor-pointer sort-option hover:bg-gray-50 hover:text-gray-800"
                                            data-sortby="harga_beli">Harga Beli</div>
                                        <div class="py-2 px-4 cursor-pointer sort-option hover:bg-gray-50 hover:text-gray-800"
                                            data-sortby="harga_jual">Harga Jual</div>
                                        <div class="py-2 px-4 cursor-pointer sort-option hover:bg-gray-50 hover:text-gray-800"
                                            data-sortby="tanggal_kadaluarsa">Kadaluarsa</div>
                                    </div>
                                </button>
                            </div>
                            {{-- Search Bar --}}
                            <form action="{{ route('obats.index') }}" method="GET" id="searchForm" class="relative">
                    ...
                    <!-- Container untuk memuat partial view tabel Obat via AJAX -->
                    <div id="obatTableContainer" class="">
                        @include('obat.partials.table')
                    </div>
                </div>
            </div>
        </main>
