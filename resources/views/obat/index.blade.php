<x-app-layout>
    <div class="p-4">
        <div class="w-full p-10 mx-auto">
                    ...
                    <div class="flex flex-row gap-2">
                        ...
                        <button id="sortByButton"
                            ...
                            <div id="sortByPopup"
                                ...
                                <div class="py-2 px-4 cursor-pointer sort-option" data-sortby="kode_obat">Kode Obat</div>
                                <div class="py-2 px-4 cursor-pointer sort-option" data-sortby="nama_obat">Nama Obat</div>
                                <div class="py-2 px-4 cursor-pointer sort-option" data-sortby="stok">Stok</div>
                                <div class="py-2 px-4 cursor-pointer sort-option" data-sortby="harga_beli">Harga Beli</div>
                                <div class="py-2 px-4 cursor-pointer sort-option" data-sortby="harga_jual">Harga Jual</div>
                                <div class="py-2 px-4 cursor-pointer sort-option" data-sortby="tanggal_kadaluarsa">Kadaluarsa</div>
                            </div>
                        </button>
                    </div>
                    {{-- SEARCH BAR --}}
            ...
            <!-- Pagination links -->
            <div class="mt-4">
                {{ $obats->appends(['search' => request('search'), 'perPage' => request('perPage')])->links() }}
            </div>
        </div>
    </div>
