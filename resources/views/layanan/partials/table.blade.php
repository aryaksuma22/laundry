{{-- resources/views/layanan_folder/partials/table.blade.php --}}
<form id="deleteFormLayanan" action="{{ route('layanans.destroy', ['layanan' => 0]) }}" method="POST">
    @csrf
    @method('DELETE')
        ...
        <tbody>
            @foreach ($layanans as $layanan)
                <tr class="border hover:bg-sky-50">
                    ...
                    <td class="px-4 py-3">{{ $layanan->harga }}</td>
                    <td class="px-4 py-3">
                        <div class="flex flex-row gap-2">
                            ...
                            {{-- Single Delete --}}
                            <a href="#" class="delete-layanan" data-id="{{ $layanan->id }}">
