    ...
    <div class="h-full">
        <div class="w-5/6 p-12 mx-auto">
            <div class="container mx-auto">
                <h2 class="text-3xl font-bold mb-2 text-gray-800">Edit Data layanan</h2>
                    ...
                    <div class="flex flex-row mb-8 gap-6">
                        <div class="w-1/2">
                            ...
                            <input type="text" name="nama_pelanggan" id="nama_pelanggan"
                                ...
                                value="{{ old('nama_pelanggan', $layanan->nama_pelanggan) }}" required>
                        </div>
                        ...
                        <div class="w-1/2">
                            ...
                            <input type="text" name="no_pesanan" id="no_pesanan"
                                class="w-full px-4 py-2 border rounded-md border-gray-300"
                                value="{{ old('no_pesanan', $layanan->no_pesanan) }}" required>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-row mb-8 gap-6">
                        <div class="w-1/2">
                            ...
                            <input type="date" name="tanggal" id="tanggal"
                                class="w-full px-4 py-2 border rounded-md border-gray-300"
                                value="{{ old('tanggal', $layanan->tanggal) }}" required>
                        </div>
                        ...
                        <div class="w-1/2">
                            ...
                            <input type="number" name="berat_pesanan" id="berat_pesanan"
                                class="w-full px-4 py-2 border rounded-md border-gray-300"
                                value="{{ old('berat_pesanan', $layanan->berat_pesanan) }}" required>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-row mb-8 gap-6">
                        <div class="w-1/2">
                            ...
                            <input type="text" name="total_harga" id="total_harga"
                                class="w-full px-4 py-2 border rounded-md border-gray-300"
                                value="{{ old('total_harga', $layanan->total_harga) }}" required>
                        </div>
                        ...
                        <div class="w-1/2">
                            ...
                            <select name="status_pesanan" id="status_pesanan"
                                ...
                                <option value="Pending"
                                    {{ old('status_pesanan', $layanan->status_pesanan) == 'Pending' ? 'selected' : '' }}>
                                    Pending</option>
                                <option value="Sedang Diproses"
                                    {{ old('status_pesanan', $layanan->status_pesanan) == 'Sedang Diproses' ? 'selected' : '' }}>
                                    Sedang Diproses</option>
                                <option value="Terkirim"
                                    {{ old('status_pesanan', $layanan->status_pesanan) == 'Terkirim' ? 'selected' : '' }}>
                                    Terkirim</option>
                                <option value="Diterima"
                                    {{ old('status_pesanan', $layanan->status_pesanan) == 'Diterima' ? 'selected' : '' }}>
                                    Diterima</option>
                                <option value="Dibatalkan"
                                    {{ old('status_pesanan', $layanan->status_pesanan) == 'Dibatalkan' ? 'selected' : '' }}>
                                    Dibatalkan</option>
                                <option value="Dikembalikan"
                                    {{ old('status_pesanan', $layanan->status_pesanan) == 'Dikembalikan' ? 'selected' : '' }}>
                                    Dikembalikan</option>
                                <option value="Selesai"
                                    {{ old('status_pesanan', $layanan->status_pesanan) == 'Selesai' ? 'selected' : '' }}>
                                    Selesai</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-row mb-8 gap-6">
                        <div class="w-1/2">
                            ...
                            <input type="text" name="alamat" id="alamat"
                                class="w-full px-4 py-2 border rounded-md border-gray-300"
                                value="{{ old('alamat', $layanan->alamat) }}" required>
                        </div>
