<x-app-layout>
    <div class="p-4">
        <div class="w-full p-10 mx-auto">
                ...
                <div class="flex flex-row space-x-4 items-center">
                    <div class="flex flex-row gap-2">
                        ...
                        <button id="sortByButton"
                            ...
                            <div id="sortByPopup"
                                ...
                                <div class="py-2 px-4 cursor-pointer sort-option" data-sortby="nama_obat">Obat</div>
                                <div class="py-2 px-4 cursor-pointer sort-option" data-sortby="nama_supplier">Supplier</div>
                                <div class="py-2 px-4 cursor-pointer sort-option" data-sortby="jumlah">Jumlah</div>
                                <div class="py-2 px-4 cursor-pointer sort-option" data-sortby="harga_beli">Harga Beli
                                </div>
                                <div class="py-2 px-4 cursor-pointer sort-option" data-sortby="total_harga">Total
                                    Harga</div>
                                <div class="py-2 px-4 cursor-pointer sort-option" data-sortby="tanggal_pemmbelian">
                    ...
                    <a href="{{ route('pembelian_obats.create') }}"
                        ...
                        <div class="flex flex-row items-center gap-2">
                            ...
                            <p class="font-semibold text-white">Pembelian Baru</p>
                        </div>
                    </a>
            ...
            {{-- Tabel Data Obat --}}
            <form id="deleteForm" action="{{ route('pembelian_obats.destroy', ['pembelian_obat' => 0]) }}"
                method="POST">
                @csrf
                @method('DELETE')
                <table class="min-w-full bg-white border rounded-xl shadow-sm mb-5">
                    ...
                    <tbody>
                        @foreach ($pembelian_obats as $pembelian_obat)
                            <tr class="border">
                                <td class="px-4 py-3">
                                    <input type="checkbox" name="pembelian_obats[]"
                                        value="{{ $pembelian_obat->id }}"
            ...
            <!-- Pagination links -->
            <div class="mt-4">
                {{ $pembelian_obats->appends(['search' => request('search'), 'perPage' => request('perPage')])->links() }}
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', function(event) {
                if (!$(event.target).closest('#sortByButton').length && !$(event.target).closest(
                        '#sortByPopup').length) {
